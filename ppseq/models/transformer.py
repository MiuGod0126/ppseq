...
from ppseq.models import PaddleseqEncoderDecoderModel,PaddleseqEncoder,PaddleseqDecoder,PaddleseqIncrementalDecoder
...
class Encoder(nn.TransformerEncoder,PaddleseqEncoder):
    ''' add encoder_layers'''
    def __init__(self,
                 embed_tokens,
                 embed_positions,
...
class Decoder(nn.TransformerDecoder,PaddleseqIncrementalDecoder):
    def __init__(self,
                 embed_tokens,
                 embed_positions,
                 embed_scale,
...
from ppseq.models import (
    register_model,
    register_model_architecture,
)

@register_model("transformer")
class Transformer(PaddleseqEncoderDecoderModel):
    def __init__(self,
                 src_vocab,
                 tgt_vocab,
                 d_model=512,
...
def base_architecture(args):
    ...
    args["src_vocab"] = args.get("src_vocab", {})
    args["tgt_vocab"] = args.get("tgt_vocab", {})
    return args
