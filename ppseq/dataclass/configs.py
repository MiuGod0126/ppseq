...
from ppseq.dataclass.constants import (
...
@dataclass
class PaddleseqDataclass:
    """paddleseq base dataclass that supported fetching attributes and metas"""
...
@dataclass
class CommonConfig(PaddleseqDataclass):
...
@dataclass
class DistributedTrainingConfig(PaddleseqDataclass):
    distributed_world_size: int = field(
        default=max(1, paddle.distributed.get_world_size()),
        metadata={
...
@dataclass
class DatasetConfig(PaddleseqDataclass):
...
@dataclass
class OptimizationConfig(PaddleseqDataclass):
    max_epoch: int = field(
...
@dataclass
class CheckpointConfig(PaddleseqDataclass):
    save_dir: str = field(
...
@dataclass
class FairseqBMUFConfig(PaddleseqDataclass):
...
@dataclass
class GenerationConfig(PaddleseqDataclass):
    beam: int = field(
...
@dataclass
class CommonEvalConfig(PaddleseqDataclass):
    ...
    post_process: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                "Valid options can be found in paddleseq.data.utils.post_process."
            ),
...
@dataclass
class EvalLMConfig(PaddleseqDataclass):
...
@dataclass
class InteractiveConfig(PaddleseqDataclass):
...
@dataclass
class EMAConfig(PaddleseqDataclass):
...
@dataclass
class PaddleseqConfig(PaddleseqDataclass):
