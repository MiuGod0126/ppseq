...
import torch
from ppseq import checkpoint_utils, models, optim, utils  # CKPT太繁琐了，用以前的
from ppseq.dataclass.configs import PaddleseqConfig
from ppseq.dataclass.utils import convert_namespace_to_omegaconf
# from paddleseq.distributed import utils as distributed_utils
from ppseq.file_io import PathManager
# from fairseq.logging import meters, metrics
# from paddleseq.models.ema import build_ema
# from fairseq.nan_detector import NanDetector
from ppseq.optim import lr_scheduler
...
class Trainer(object):
    ...
    def __init__(self, cfg: PaddleseqConfig, task, model, criterion, quantizer=None):
