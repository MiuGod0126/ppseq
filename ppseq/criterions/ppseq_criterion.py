...
class PaddleseqCriterion(nn.Layer):
    ...
    @classmethod
    def build_criterion(cls, cfg: PaddleseqDataclass, task):
...
class LegacyPaddleseqCriterion(PaddleseqCriterion):
    def __init__(self, args, task):
        ...
        logger.info(
            ...
            "extending PaddleseqCriterion instead of LegacyPaddleseqCriterion."
        )
