...
dependency: # 都是numpy，直接搬
    data_utils.batch_by_size √
    data_utils._filter_by_size_dynamic √
'''
import paddle
import logging
import numpy as np
...
class PaddleseqDataset(paddle.io.Dataset, EpochListening):
...
class PaddleseqIterableDataset(paddle.io.IterableDataset, EpochListening):
    """
